...
public class AlugarVeiculoFrame extends javax.swing.JFrame {
    ...
    private void FinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FinalizarActionPerformed
        try {
            ...
            Logger.getLogger(AlugarVeiculoFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlugarVeiculoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
